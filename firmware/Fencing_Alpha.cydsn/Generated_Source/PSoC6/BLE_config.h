 ...
 */
#define CY_BLE_FENCINGSERVICE_SERVICE_INDEX   (0x00u) /* Index of FencingService service in the cy_ble_customs array */
#define CY_BLE_FENCINGSERVICE_HITPACKET_CHAR_INDEX   (0x00u) /* Index of HitPacket characteristic */
#define CY_BLE_FENCINGSERVICE_HITPACKET_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_FENCINGSERVICE_HITPACKET_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_CHAR_INDEX   (0x01u) /* Index of WeaponChange characteristic */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_FENCINGSERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of FencingService service */
#define CY_BLE_FENCINGSERVICE_HITPACKET_DECL_HANDLE   (0x0011u) /* Handle of HitPacket characteristic declaration */
#define CY_BLE_FENCINGSERVICE_HITPACKET_CHAR_HANDLE   (0x0012u) /* Handle of HitPacket characteristic */
#define CY_BLE_FENCINGSERVICE_HITPACKET_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_FENCINGSERVICE_HITPACKET_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_DECL_HANDLE   (0x0015u) /* Handle of WeaponChange characteristic declaration */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_CHAR_HANDLE   (0x0016u) /* Handle of WeaponChange characteristic */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0017u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_FENCINGSERVICE_WEAPONCHANGE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0018u) /* Handle of Client Characteristic Configuration descriptor */
