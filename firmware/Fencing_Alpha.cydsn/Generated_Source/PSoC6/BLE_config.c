...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x0Bu, 0x09u, 0x46u, 0x65u,
        0x6Eu, 0x63u, 0x69u, 0x6Eu, 0x67u, 0x5Fu, 0x50u,
        0x32u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x3Eu] = {
    /* Device Name */
    (uint8_t)'F', (uint8_t)'e', (uint8_t)'n', (uint8_t)'c', (uint8_t)'i', (uint8_t)'n', (uint8_t)'g', (uint8_t)'_',
(uint8_t)'P', (uint8_t)'2', 
    ...
    0x06u, 0x00u, 0x06u, 0x00u, 0x00u, 0x00u, 0xE8u, 0x03u, 
    ...
    /* Custom Descriptor */
    0x00u, 0x7Eu, 0xB3u, 0x86u, 0x72u, 0xFDu, 0xFBu, 0x5Au, 0x96u, 0x1Eu, 0x47u, 0xF2u, 0x62u, 0x56u, 0x4Bu, 0xA4u, 0xE3u, 

    /* WeaponChange */
    0x00u, 

    /* Custom Descriptor */
    0x00u, 0xA0u, 0x32u, 0x46u, 0x02u, 0x7Cu, 0x9Fu, 0x4Au, 0x96u, 0x7Au, 0x4Au, 0xF9u, 0x48u, 0x01u, 0xDCu, 0x50u, 0x36u, 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* FencingService */
    { 0x3Cu, 0xEEu, 0xE4u, 0xAEu, 0x15u, 0x8Eu, 0x9Fu, 0xB0u, 0x7Du, 0x4Du, 0xF0u, 0x29u, 0x1Fu, 0x55u, 0xC9u, 0x20u },
    /* HitPacket */
    { 0x19u, 0x68u, 0x1Au, 0xBDu, 0x6Au, 0x52u, 0x1Eu, 0x8Fu, 0x24u, 0x45u, 0xEBu, 0xA6u, 0x8Eu, 0x0Du, 0x01u, 0x36u },
    /* WeaponChange */
    { 0x63u, 0x1Fu, 0x13u, 0x63u, 0xE8u, 0x9Au, 0x21u, 0xA0u, 0x74u, 0x4Bu, 0x71u, 0x63u, 0x80u, 0x99u, 0xEDu, 0x9Bu },
};

static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x10u] = {
    { 0x000Au, (void *)&cy_ble_attValues[0] }, /* Device Name */
    { 0x0002u, (void *)&cy_ble_attValues[10] }, /* Appearance */
    { 0x0008u, (void *)&cy_ble_attValues[12] }, /* Peripheral Preferred Connection Parameters */
    { 0x0001u, (void *)&cy_ble_attValues[20] }, /* Central Address Resolution */
    { 0x0001u, (void *)&cy_ble_attValues[21] }, /* Resolvable Private Address Only */
    { 0x0004u, (void *)&cy_ble_attValues[22] }, /* Service Changed */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* FencingService UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* HitPacket UUID */
    { 0x0001u, (void *)&cy_ble_attValues[26] }, /* HitPacket */
    { 0x0001u, (void *)&cy_ble_attValues[27] }, /* Custom Descriptor */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* WeaponChange UUID */
    { 0x0001u, (void *)&cy_ble_attValues[44] }, /* WeaponChange */
    { 0x0001u, (void *)&cy_ble_attValues[45] }, /* Custom Descriptor */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x18u] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x01020001u /* rd     */, 0x0003u, {{0x000Au, (void *)&cy_ble_attValuesLen[0]}} },
    ...
    { 0x0012u, 0x0D8Eu /* HitPacket                           */, 0x09120001u /* rd,ntf */, 0x0014u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x4B56u /* Custom Descriptor                   */, 0x09000001u /*        */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00080001u /* wr     */, 0x0018u, {{0x0010u, (void *)&cy_ble_attValuesLen[12]}} },
    { 0x0016u, 0x9980u /* WeaponChange                        */, 0x09080100u /* wr     */, 0x0018u, {{0x0001u, (void *)&cy_ble_attValuesLen[13]}} },
    { 0x0017u, 0xDC01u /* Custom Descriptor                   */, 0x09000001u /*        */, 0x0017u, {{0x0001u, (void *)&cy_ble_attValuesLen[14]}} },
