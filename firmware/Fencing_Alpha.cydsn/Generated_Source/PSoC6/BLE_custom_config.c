...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* FencingService service */
    {
        0x0010u, /* Handle of the FencingService service */ 
        {

            /* HitPacket characteristic */
            {
                0x0012u, /* Handle of the HitPacket characteristic */ 
            ...
            /* WeaponChange characteristic */
            {
                0x0016u, /* Handle of the WeaponChange characteristic */ 
