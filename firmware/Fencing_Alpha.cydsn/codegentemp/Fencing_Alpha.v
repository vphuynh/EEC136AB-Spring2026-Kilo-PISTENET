// ======================================================================
// Fencing_Alpha.v generated from TopDesign.cysch
// 06/04/2026 at 11:40
...
module CapSense_v3_0_2 ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("a4445676-b3df-460c-9086-e2860a5ed179/4db2e9d3-9f70-4f4e-a919-7eefada41863"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("a4445676-b3df-460c-9086-e2860a5ed179/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a4445676-b3df-460c-9086-e2860a5ed179/0113321b-4a37-46f6-8407-2f8646c68756"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
...
module SCB_UART_PDL_v2_0_3 (
	...
	cy_clock_v1_0
		#(.id("a69572fa-8565-403a-9a0f-7d2434a3f798/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a69572fa-8565-403a-9a0f-7d2434a3f798/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a69572fa-8565-403a-9a0f-7d2434a3f798/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=24999, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=SampleCounter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SampleCounter, CY_INSTANCE_SHORT_NAME=SampleCounter, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=SampleCounter, )
...
module top ;
	...
	wire [0:0] tmpFB_0__ButtonSense_net;
	wire [0:0] tmpIO_0__ButtonSense_net;
	electrical [0:0] tmpSIOVREF__ButtonSense_net;
	...
	cy_mxs40_gpio_v1_0
		...
		ButtonSense
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ButtonSense_net[0:0]}),
		  .io({tmpIO_0__ButtonSense_net[0:0]}),
		  .siovref(tmpSIOVREF__ButtonSense_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("44e33c55-6447-487c-be2c-7d3a7940c144"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	wire [0:0] tmpFB_0__ButtonDrive_net;
	wire [0:0] tmpIO_0__ButtonDrive_net;
	electrical [0:0] tmpSIOVREF__ButtonDrive_net;

	cy_mxs40_gpio_v1_0
		#(.id("c8bd1de8-4a05-4e7d-b01d-028d25420160"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
		...
		ButtonDrive
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ButtonDrive_net[0:0]}),
		  .io({tmpIO_0__ButtonDrive_net[0:0]}),
		  .siovref(tmpSIOVREF__ButtonDrive_net));
    ...
    cy_annotation_universal_v1_0 C_seen_by_weapon (
        .connect({
            Net_29,
            Net_34
        })
    );
    defparam C_seen_by_weapon.comp_name = "Capacitor_v1_0";
    defparam C_seen_by_weapon.port_names = "T1, T2";
    defparam C_seen_by_weapon.width = 2;
    ...
    TCPWM_Counter_PDL_v1_0_4 SampleCounter (
        .capture(1'b0),
        .clock(Net_47),
        .compare(Net_43),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("6dabceb3-89c7-4188-a338-0b3339be1372"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(1),
		  .period("0"),
		  .is_direct(0),
