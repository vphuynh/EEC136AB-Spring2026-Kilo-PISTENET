// ======================================================================
// Fencing_P1_GPIO_Test.v generated from TopDesign.cysch
// 05/01/2026 at 02:02
...
module top ;
	...
	wire [0:0] tmpFB_0__LEDCapSense_net;
	wire [0:0] tmpIO_0__LEDCapSense_net;
	electrical [0:0] tmpSIOVREF__LEDCapSense_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LEDCapSense
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LEDCapSense_net[0:0]}),
		  .io({tmpIO_0__LEDCapSense_net[0:0]}),
		  .siovref(tmpSIOVREF__LEDCapSense_net));
	...
	wire [0:0] tmpFB_0__LEDButton_net;
	wire [0:0] tmpIO_0__LEDButton_net;
	electrical [0:0] tmpSIOVREF__LEDButton_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LEDButton
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LEDButton_net[0:0]}),
		  .io({tmpIO_0__LEDButton_net[0:0]}),
		  .siovref(tmpSIOVREF__LEDButton_net));
